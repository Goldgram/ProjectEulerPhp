...
$tri[4] = array(20,04,82,47,65);
$tri[5] = array(19,01,23,75,03,34);
$tri[6] = array(88,02,77,73,07,63,67);
$tri[7] = array(99,65,04,28,06,16,70,92);
...
$tri[13] = array(63,66,04,68,89,53,67,30,73,16,69,87,40,31);
$tri[14] = array(04,62,98,27,23,09,70,98,73,93,38,53,60,04,23);

$sumTri[0] = array(75);
// $sumTri[1] = array(0,0);
// $sumTri[2] = array(0,0,0);
// $sumTri[3] = array(0,0,0,0);
...
for ($i=0; $i < 14; $i++) {
	for ($j=0; $j < count($tri[$i]); $j++) { 
		//echo $tri[$i][$j]," => ",$sumTri[$i][$j],"\n";

		//$sumTri[$i+1][$j] = $sumTri[$i][$j] + $tri[$i+1][$j];
		...
		//$sumTri[$i+1][$j+1] = $sumTri[$i][$j] + $tri[$i+1][$j+1];
